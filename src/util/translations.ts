...
const translations: Record<Language, Translations> = {
  sv: {
    ...
    privacyPolicySection7Content:
      "Vi använder AI-assistenter (Claude från Anthropic och Gemini från Google) för att hjälpa dig förstå tentamaterial. För att säkerställa kvaliteten och förbättra tjänsten gäller följande:",
    ...
    aiIntroTitle: "LiU Tentor AI",
    aiIntroSubtitle: "Din personliga studieassistent",
    aiIntroDescription:
      "Vi har integrerat Claude och Gemini som hjälper dig att förstå och lära dig från tentor. Ställ frågor, få förklaringar och förbättra din förståelse.",
  ...
  en: {
    ...
    privacyPolicySection7Content:
      "We use AI assistants (Claude by Anthropic and Gemini by Google) to help you understand exam materials. To ensure quality and improve the service, the following applies:",
    privacyPolicySection7Item1:
    ...
    aiIntroDescription:
      "We've integrated Claude and Gemini to help you understand and learn from exams. Ask questions, get explanations, and improve your understanding.",
