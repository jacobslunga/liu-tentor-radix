...
const updates: Update[] = [
  ...
  },
  {
    ...
    description: {
      sv: "Få hjälp med tentorna direkt i gränssnittet med vår nya AI-chatt som drivs av Claude och Gemini.",
      en: "Get help with exams directly in the interface with our new AI chat powered by Claude and Gemini.",
    },
  },
  {
    version: "2.0.0",
