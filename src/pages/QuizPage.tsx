...
const QuizPage: FC = () => {
  ...
  const sidebar = (
    <aside className='flex w-full shrink-0 flex-col gap-6 bg-secondary p-5 md:sticky md:top-0 md:h-screen md:w-72 lg:w-80'>
      ...
      <div className='mt-auto pt-6'>
        <div className='w-full rounded-xl border bg-background px-4 py-3 text-sm font-medium leading-relaxed wrap-break-word text-foreground'>
          {language === 'sv'
    ...
    mainContent = (
      <div className='animate-in fade-in duration-500'>
        ...
        <div className='pb-10 sm:pb-12'>
            ...
            {currentQuestion.options.map((option, optionIndex) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'group flex w-full cursor-pointer items-center gap-3 rounded-xl border p-3 text-left transition-all duration-200 sm:p-4',
                    selected
          ...
          <div className='sticky bottom-0 z-20 mt-6 flex flex-wrap items-center justify-between gap-4 border-t bg-background py-4'>
            <div className='flex gap-3'>
              ...
              <Button
                ...
                disabled={
                  currentIndex === questionCount - 1 || !hasAnsweredCurrent
                }
              >
  ...
  return (
    <div className='flex min-h-screen flex-col bg-background md:h-screen md:flex-row md:overflow-hidden'>
      ...
      <main className='flex-1 overflow-y-auto px-4 py-8 sm:px-6 md:px-8 md:pt-8 md:pb-0 lg:px-12 lg:pt-12 lg:pb-0'>
        <div className='mx-auto w-full max-w-3xl'>{mainContent}</div>
      </main>
    </div>
  );
};
