      ...
      <div className='flex gap-2 overflow-x-auto mt-2'>
        {recentActivities.map((activity) => (
          <Link
            key={activity.path}
            to={activity.path}
            className='flex items-center gap-2 group text-sm px-3 py-2 bg-white dark:bg-black text-black dark:text-white hover:opacity-80 transition-opacity duration-200 rounded-xl whitespace-nowrap'
          >
