...
const PDFModal: FC<PDFModalProps> = ({
  ...
  return (
    <div
      ref={containerRef}
      className="w-full mt-0 h-screen md:mt-[3.5rem] md:max-h-[calc(100vh - 3.5rem)] relative bg-background flex flex-col items-center justify-center overflow-hidden"
    >
      {error ? (
