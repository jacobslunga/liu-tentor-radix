    ...
    >
      <div className="absolute inset-x-0 top-0 z-40 flex items-center gap-3 px-3 h-12 bg-linear-to-b from-background to-transparent">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm font-normal text-foreground truncate leading-tight">
            {courseCode}
          </p>
        ...
        {hasSolution && (
          <button
            ...
            className="shrink-0 inline-flex items-center gap-1.5 h-8 px-3 rounded-lg border border-border bg-background text-foreground text-xs font-normal active:scale-95 transition-transform"
