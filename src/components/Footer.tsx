...
const Footer: FC = () => {
  ...
  return (
    <footer className="w-full bg-card py-10 border-border mt-auto flex flex-col items-center justify-center relative z-10">
      {/* Länkar */}
      <div className="flex flex-col sm:flex-row justify-center items-center md:items-start gap-12 sm:gap-24 text-sm text-foreground/70">
        {groupedLinks.map((section) => (
          <div key={section.title} className="text-center sm:text-left">
            <h4 className="text-foreground/80 font-semibold mb-2">
              {section.title}
            </h4>
